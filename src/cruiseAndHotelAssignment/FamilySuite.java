...
public class FamilySuite extends HotelBookings {
	...
	public int getNoOfRooms() {
		...
		while (roomsNeeded > noOfRooms) {
			System.out.println(
					"Number of rooms provided by you, can not accomodate all the guests. "
					+ "\n You need to book atleast "
							+ roomsNeeded + " rooms. Please enter correct number of the rooms again.");
			noOfRooms = Integer.parseInt(sc.nextLine().trim());
		}
		return noOfRooms;
	}
